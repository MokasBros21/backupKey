...
const TableReportesCliente = () => {
    ...
    useEffect(() =>{
        if(token === null){
            ...
            urlinicio = Url + 'reportes?proyecto='+id_proyect
    ...
    const handleChangeMotivo = (event) => {        
        ...
        var urlactivaMotivo = Url + 'reportes?proyecto='+id_proyect+'&pdl='
                            +pdlbuscado+'&estados='+estatus+'&canal='+selectcanal+
                            '&fecha='+(tipofechaC+","+tipofechaA+","+tipofechaR)
                            +'&desde='+(fechadesdeC+","+fechadesdeA+","+fechadesdeR)
                            +'&hasta='+(fechahastaC+","+fechahastaA+","+fechahastaR)
    ...
    const filtrarFechaCreacion = () => {
        ...
        var urlfechaCreacion = Url + 'reportes?proyecto='+id_proyect+'&pdl='
                                +pdlbuscado+'&estados='+estatus+'&canal='+selectcanal+
                                '&fecha='+(tipofechaC+","+tipofechaA+","+tipofechaR)
                                +'&desde='+(fechadesdeC+","+fechadesdeA+","+fechadesdeR)
                                +'&hasta='+(fechahastaC+","+fechahastaA+","+fechahastaR)
    ...
    const filtrarFechaAtencion = () => {
        ...
        var urlfechaAtencion = Url + 'reportes?proyecto='+id_proyect+'&pdl='
                                +pdlbuscado+'&estados='+estatus+'&canal='+selectcanal+
                                '&fecha='+(tipofechaC+","+tipofechaA+","+tipofechaR)
                                +'&desde='+(fechadesdeC+","+fechadesdeA+","+fechadesdeR)
                                +'&hasta='+(fechahastaC+","+fechahastaA+","+fechahastaR)
                ...
                size="small" />}>
                    <TabContext value={value}>
                        ...
                        <TabPanel value="InfoReportes" sx={{padding:0}}>
                            ...
                            showoptions={false} reloadpanel={abrirPanel} tablaReportes={true} />
                        </TabPanel>
                                    ...
                                    <Popover
                                        ...
                                        <Box p={1} component="div">
                                            <Select
                                                ...
                                                variant="standard">
                                                <MenuItem value={0} disabled>-Seleccione-</MenuItem>
                                                <MenuItem value={"ERROR DE AVISO"}>ERROR DE AVISO</MenuItem>
...
export default TableReportesCliente;