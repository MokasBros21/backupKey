...
const DashboardEnProceso = () =>{
 ...
 //PETICIÓN DEL GEOJSON MAPA
  const geojsonMapa= (fechaInicio,fechaFin,cuadrilla,canal) => {
   axios.get(Url +"dashboard/enproceso/geojson?proyecto="+id_proyect+"&fecha_inicio="+fechaInicio+"&fecha_fin="
  ...
  const resumenConsulta =(fechaInicio,fechaFin,cuadrilla,canal) => {
    axios.get(Url + "dashboard/enproceso/resumen?proyecto="+id_proyect+"&fecha_inicio="+fechaInicio+"&fecha_fin="
    +fechaFin+"&cuadrilla="+cuadrilla+"&canal="+canal, {
        headers: {
            Authorization : token,
        }
  ...
  axios.get(Url + "dashboard/enproceso/sector?proyecto="+id_proyect+"&fecha_inicio="+fechaInicio+"&fecha_fin="
  +fechaFin+"&cuadrilla="+cuadrilla+"&canal="+canal, {
      headers: {
          Authorization : token,
      }
 ...
 .then(res =>  {
  ...
  axios.get(Url + "dashboard/enproceso/tiempoatencion?proyecto="+id_proyect+"&fecha_inicio="+fechaInicio+"&fecha_fin="
  +fechaFin+"&cuadrilla="+cuadrilla+"&canal="+canal, {
    headers: {
        Authorization : token,
    }
   ...
   informacionCuadrilla();
    ...
    return(
      ...
      <FormControl sx={{ m: 1, width: 300 }}>
        ...
        <Grid item xs={12}>
        <div className='contenedorTabla'><ReactEcharts option={graficaSectores} /></div>
        </Grid>
        <Grid item xs={12}>
...
export default DashboardEnProceso;